      ...
      <div className="container mx-auto h-full">
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1">
            Hello I'm <br /> <span className="text-accent"> Shashank Janagam Chandra </span>
            </h1>
            <p className="max-w-[500px] mb9 text-white/80">I am a passionate Software Developer with experience in creating scalable, user-friendly web applications.</p>
            ...
            <a href="/assets/resume/Shashank_Janagam_chandra_Resume.pdf" download>
              <Button
                variant="outline"
                size="lg"
                className="uppercase flex items-cemter gap-2">
